...
using MigrationTool.DecisionTrees.Auth.API.Helpers;
using MigrationTool.DecisionTrees.Auth.API.ViewModels.Authorization;
...
namespace MigrationTool.DecisionTrees.Auth.API.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Userinfo()
        {
            ...
            claims[Claims.FamilyName] = user.FirstName + " " + user.LastName;
        ...
        #region POST
        [HttpPost("~/connect/token-by-password"), IgnoreAntiforgeryToken, Produces("application/json")]
        public async Task<IActionResult> ExchangePassword()
        {
            ...
            if (request.IsPasswordGrantType())
            {
                ...
                if (!result.Succeeded)
                {
                    var properties = new AuthenticationProperties(new Dictionary<string, string>
                    {
                        [OpenIddictServerAspNetCoreConstants.Properties.Error] = Errors.InvalidGrant,
                        [OpenIddictServerAspNetCoreConstants.Properties.ErrorDescription] =
                            "The username/password couple is invalid or email is not confirmed."
                    });
                ...
                return SignIn(new ClaimsPrincipal(principal), OpenIddictServerAspNetCoreDefaults.AuthenticationScheme);
            }
